...
def number_pattern(n):
    ...
    for i in range(1, n + 1):
        result += str(i) + ' '
    return result.strip()
print(number_pattern(5))  # Expected output: "1 2 3 4 5"

numbers = [1,3,5,0,-2,4.5]
numsort = sorted(numbers,reverse=True)
print(numsort)  # Expected output: [5, 4, 3, 1, 'a', 0, -2, 4.5]